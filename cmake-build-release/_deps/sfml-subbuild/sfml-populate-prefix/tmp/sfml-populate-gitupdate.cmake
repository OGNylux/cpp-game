...
execute_process(
  COMMAND "C:/Users/a3445/AppData/Local/Programs/Git/cmd/git.exe" --git-dir=.git show-ref "2.6.x"
  WORKING_DIRECTORY "D:/Uni/4. Semester/cpp-game/cmake-build-release/_deps/sfml-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/Uni/4. Semester/cpp-game/cmake-build-release/_deps/sfml-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/Uni/4. Semester/cpp-game/cmake-build-release/_deps/sfml-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
